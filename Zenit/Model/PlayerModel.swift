...
//    static let listOfPlayers = ["Андрей Лунёв",
//                                "Александр Васютин",
//                                "Михаил Кержаков",
//                                "Игорь Смольников",
//                                "Ярослав Ракицкий",
...
//    static let positions = ["Вратарь", "Защитник", "Полузащитник", "Нападающий"]
    
    // Russian: "Андрей Лунёв", "Александр Васютин", "Михаил Кержаков", "Игорь Смольников", "Вячеслав Караваев", "Юрий Жирков", "Магомед Оздоев", "Леон Мусаев", "Алексей Сутормин", "Далер Кузяев", "Александр Ерохин", "Олег Шатов", "Артём Дзюба"
    // Argentinian: "Эмануэль Маммана", "Матиас Кранневитер", "Себастьян Дриусси"
    // Brazilian: "Дуглас Сантос", "Малком"
    // Venezuelian: "Йордан Осорио"
    // Iranian: "Сердар Азмун"
    // Columbian: "Вильмар Барриос"
    // Serbian: "Бранислав Иванович"
    // Ukranian: "Ярослав Ракицкий"
    
    
//    static let countries = [ "Россия 🇷🇺", "Аргенитина 🇦🇷", "Бразилия 🇧🇷", "Венесуэла🇻🇪",
//                             "Иран 🇮🇷", "Колумбия 🇨🇴", "Сербия 🇷🇸", "Украина 🇺🇦"]
    // MARK: Биографии игроков
...
//    let aDzyuba = "Артем Сергеевич Дзюба родился в Москве. Воспитанник академии «Спартака», в 2006-м году дебютировал в основном составе команды. С 2009-го на правах аренды выступал за «Томь» и «Ростов», в «Зените» — с 1 июля 2015-го."
    ...
    // MARK: Функция, добавляющая игрока в ячейку
